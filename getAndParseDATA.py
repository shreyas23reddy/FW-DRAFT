...
class deleteData():
    ...
    def deletevSmartPolicy(vmanage_host,vmanage_port,header,newActivevSmartpolicyId):
        api_delete_vsmart_policy = f'/dataservice/template/policy/vsmart/{newActivevSmartpolicyId}'
        url_delete_vsmart_policy = Operation.url(vmanage_host,vmanage_port,api_delete_vsmart_policy)
        data_delate_vsmart_policy = Operation.delete_method(url_delete_vsmart_policy,header)
        return data_delate_vsmart_policy

    def deleteSiteList(vmanage_host,vmanage_port,header,siteListId):
        api_delete_Site_List = f'/dataservice/template/policy/list/site/{siteListId}'
        url_delete_Site_List = Operation.url(vmanage_host,vmanage_port,api_delete_Site_List)
        data_delete_Site_List = Operation.delete_method(url_delete_Site_List,header)
        return data_delete_Site_List
